...
## JWT Handler for Awesome Enterprise

Added support for using JWT to encode and decode access token in Awesome Enterprise
...
```composer require wpoets/jwt-handler```
